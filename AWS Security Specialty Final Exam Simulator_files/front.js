stickyElem = document.querySelector("#toc_container");
contentAria = document.querySelector(".entry-content.single");
...
if (window.innerWidth > 1200) {
    window.onscroll = function () {
        ...
        the element */
        if (window.pageYOffset > (contentAria.getBoundingClientRect().top + 40)) {
            if (window.pageYOffset >= (contentAria.offsetHeight - 650)) {
                stickyElem.style.position = "absolute";
                stickyElem.style.top = "73%";
                stickyElem.style.right = "-32px";
            } else {
                stickyElem.style.position = "fixed";
                stickyElem.style.top = "92px";
                stickyElem.style.right = "102px";
                stickyElem.style.bottom = "unset";
            }
        } else {
            stickyElem.style.position = "absolute";
            stickyElem.style.top = "unset";
            stickyElem.style.right = "-30px";
            stickyElem.style.bottom = "unset";
        }
    }
}
